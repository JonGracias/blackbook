...
und('beep4.ogg')
bles for a new game
he pattern of colors
olor the player must push next
estamp of the player's last button push

rn is playing. when True, waiting for the player to click a colored button:
